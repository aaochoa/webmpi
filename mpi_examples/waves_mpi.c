...
A C program which uses finite differences and MPI to estimate a solution to the wave equation.
https://people.sc.fsu.edu/~jburkardt/c_src/wave_mpi/wave_mpi.html
